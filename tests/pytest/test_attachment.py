...
class TestAttachments():
    ...
    def test_create_attachment_from_url(self):
        ...
        status_code, response = self.attachments_manager.create_attachment_from_url(url=url, card_id=card_id, name=name, set_cover=set_cover)
        ...
        attachment_name = response.pop('name')
